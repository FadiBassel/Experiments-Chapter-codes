//The purpose of this file is to control the snake robot so it can slither forward for 19 seconds
// (approximately 3 meters), make a turn,then slither forward, make a turn and repeat.
...
void loop() {
  ...
  else if(millis() >= 19000 & millis() < 23500)
  {
    slither(20, 35, 2, 1.5);           // turn slither
  }
  else if(millis() >= 23500 & millis() < 43000)
  {
    slither(0, 35, 2, 1.5);           // forwards slither
  }
  else if(millis() >= 43000 & millis() < 47500)
  {
    slither(20, 35, 2, 1.5);           // turn slither
  }
  else if(millis() >= 47500 & millis() < 67000)
  {
    slither(0, 35, 2, 1.5);           // forwards slither
  }
  else if(millis() >= 67000 & millis() < 71500)
  {
    slither(20, 35, 2, 1.5);           // turn slither
  }
   else if(millis() >= 71500 & millis() < 91000)
  {
    slither(0, 35, 2, 1.5);           // forwards slither
  }
  else if(millis() >= 91000 & millis() < 95500)
  {
    slither(20, 35, 2, 1.5);           // turn slither
  }
  else if(millis() >= 95500 & millis() < 115000)
  {
    slither(0, 35, 2, 1.5);           // forwards slither
  }
  else if(millis() >= 115000 & millis() < 195000)
  {
    slither(20, 35, 2, 1.5);           // turn slither
  }
   else if(millis() >= 195000 & millis() < 139000)
  {
    slither(0, 35, 2, 1.5);           // forwards slither
  }
  else if(millis() >= 139000 & millis() < 143500)
  {
    slither(20, 35, 2, 1.5);           // turn slither
  }
  else
